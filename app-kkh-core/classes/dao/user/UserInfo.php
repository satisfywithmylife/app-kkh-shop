...
SQL;
    ...
    public function get_user_info_by_wx_info($wx_openid, $wx_unionid) {
        $sql = "select uid, kkid, name, pass, mail, mail_verified, mobile_num, mobile_verified, wechat, weibo, tengqq, wx_openid, wx_unionid, min_openid, tel_num, access, login, picture, v_status, v_date, client_ip, last_client_ip, created, update_date from t_users where `wx_openid` = ? limit 1;";        
        $stmt = $this->pdo->prepare($sql);
	...
	public function get_user_info_by_wx_unionid($wx_unionid) {
		...
		$sql = "select `uid`, `kkid`, `name`, `pass`, `mail`, `mail_verified`, `mobile_num`, `mobile_verified`, `wechat`, `weibo`, `tengqq`, `tel_num`, `wx_unionid`, `wx_openid`, `min_openid`, `access`, `login`, `picture`, `v_status`, `v_date`, `client_ip`, `last_client_ip`, `created`, `update_date`, `user_photo`, `user_address`, `data_source` from `t_users` where `wx_unionid` = ? limit 1;";
		$stmt = $this->pdo->prepare($sql);
	...
	public function get_user_by_kkid($kkid) {
		$sql = "select `uid`, `kkid`, `name`, `pass`, `mail`, `mail_verified`, `mobile_num`, `mobile_verified`, `wechat`, `weibo`, `tengqq`, `tel_num`, `wx_unionid`, `wx_openid`, `min_openid`, `access`, `login`, `picture`, `v_status`, `v_date`, `client_ip`, `last_client_ip`, `created`, `update_date`, `user_photo`, `user_address`, `data_source` from `t_users` where kkid = ?  and v_status = 1 limit 1 ;";
		$stmt = $this->pdo->prepare($sql);
	...
	public function set_user_by_kkid($kkid, $data) {
		...
		$sql = "update t_users set name = :name, mail = :mail, mail_verified = :mail_verified, wechat = :wechat, weibo = :weibo, tengqq = :tengqq, tel_num = :tel_num, picture = :picture where kkid = :kkid ;";
		$stmt = $this->pdo->prepare($sql);
...
//print_r($type);
    ...
    public function user_register($user) {
        ...
        $sql = "insert into t_users (uid, kkid, name, pass, mail, mail_verified, mobile_num, mobile_verified, wechat, weibo, tengqq, tel_num, access, login, picture, v_status, v_date, client_ip, last_client_ip, created, update_date) values(:uid, replace(upper(uuid()),'-',''), :name, :pass, :mail, :mail_verified, :mobile_num, :mobile_verified, :wechat, :weibo, :tengqq, :tel_num, :access, :login, :picture, :v_status, :v_date, :client_ip, :last_client_ip, :created, now());";
