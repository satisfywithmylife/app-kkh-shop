...
class Smarty_Internal_Configfileparser
{
    ...
    public $kkidx;                    /* Index of top element in stack */
    ...
    public function yy_pop_parser_stack()
    {
        ...
        if ($this->yyTraceFILE && $this->kkidx >= 0) {
    ...
    public function yy_get_expected_tokens($token)
    {
        static $res3 = array();
        static $res4 = array();
        $state = $this->yystack[$this->kkidx]->stateno;
        ...
        do {
            ...
            if ($yyact >= self::YYNSTATE && $yyact < self::YYNSTATE + self::YYNRULE) {
                ...
                do {
                    ...
                    $this->kkidx -= self::$yyRuleInfo[$yyruleno][1];
                    $nextstate = $this->yy_find_reduce_action($this->yystack[$this->kkidx]->stateno, self::$yyRuleInfo[$yyruleno][0]);
    ...
    {
        $stateno = $this->yystack[$this->kkidx]->stateno;

        /* if ($this->kkidx < 0) return self::YY_NO_ACTION;  */
    ...
    {
        $this->kkidx ++;
        if ($this->kkidx >= self::YYSTACKDEPTH) {
            $this->kkidx --;
            if ($this->yyTraceFILE) {
    ...
    function yy_r1()
    {
        $this->add_global_vars($this->yystack[$this->kkidx + 0]->minor);
        $this->_retvalue = null;
    }
    ...
    function yy_r4()
    {
        $this->add_section_vars($this->yystack[$this->kkidx + - 3]->minor, $this->yystack[$this->kkidx + 0]->minor);
        $this->_retvalue = null;
    }
    ...
    function yy_r6()
    {
        $this->_retvalue = $this->yystack[$this->kkidx + - 1]->minor;
    }

    #line 297 "../smarty/lexer/smarty_internal_configfileparser.y"
    function yy_r7()
    {
        $this->_retvalue = array_merge($this->yystack[$this->kkidx + - 1]->minor, Array($this->yystack[$this->kkidx + 0]->minor));
    }
    ...
    function yy_r9()
    {
        $this->_retvalue = Array("key"   => $this->yystack[$this->kkidx + - 2]->minor,
                                 "value" => $this->yystack[$this->kkidx + 0]->minor);
    }

    #line 312 "../smarty/lexer/smarty_internal_configfileparser.y"
    function yy_r10()
    {
        $this->_retvalue = (float) $this->yystack[$this->kkidx + 0]->minor;
    }

    #line 316 "../smarty/lexer/smarty_internal_configfileparser.y"
    function yy_r11()
    {
        $this->_retvalue = (int) $this->yystack[$this->kkidx + 0]->minor;
    }

    #line 320 "../smarty/lexer/smarty_internal_configfileparser.y"
    function yy_r12()
    {
        $this->_retvalue = $this->parse_bool($this->yystack[$this->kkidx + 0]->minor);
    }

    #line 324 "../smarty/lexer/smarty_internal_configfileparser.y"
    function yy_r13()
    {
        $this->_retvalue = self::parse_single_quoted_string($this->yystack[$this->kkidx + 0]->minor);
    }

    #line 328 "../smarty/lexer/smarty_internal_configfileparser.y"
    function yy_r14()
    {
        $this->_retvalue = self::parse_double_quoted_string($this->yystack[$this->kkidx + 0]->minor);
    }

    #line 332 "../smarty/lexer/smarty_internal_configfileparser.y"
    function yy_r15()
    {
        $this->_retvalue = self::parse_tripple_double_quoted_string($this->yystack[$this->kkidx + - 1]->minor);
    }
    ...
    function yy_r17()
    {
        $this->_retvalue = $this->yystack[$this->kkidx + 0]->minor;
    }
    ...
    public function yy_reduce($yyruleno)
    {
        ...
        $yyact = $this->yy_find_reduce_action($this->yystack[$this->kkidx]->stateno, $yygoto);
    ...
    public function doParse($yymajor, $yytokenvalue)
    {
        ...
        if ($this->kkidx === null || $this->kkidx < 0) {
            $this->kkidx = 0;
            $this->yyerrcnt = - 1;
            $x = new TPC_yyStackEntry;
            $x->stateno = 0;
        ...
        do {
            ...
            if ($yyact < self::YYNSTATE) {
                ...
                if (self::YYERRORSYMBOL) {
                    ...
                    $yymx = $this->yystack[$this->kkidx]->major;
                    if ($yymx == self::YYERRORSYMBOL || $yyerrorhit) {
                        ...
                        while ($this->kkidx >= 0 && $yymx != self::YYERRORSYMBOL && ($yyact = $this->yy_find_shift_action(self::YYERRORSYMBOL)) >= self::YYNSTATE) {
                            $this->yy_pop_parser_stack();
                        }
                        if ($this->kkidx < 0 || $yymajor == 0) {
                            $this->yy_destructor($yymajor, $yytokenvalue);
        ...
        } while ($yymajor != self::YYNOCODE && $this->kkidx >= 0);
    }
}
