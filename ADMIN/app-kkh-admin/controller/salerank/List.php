...
class Salerank_ListController extends APF_Controller
{
    ...
    {   
		...
		$rank_list = [];
		$rank_list = $bll_salerank_info->get_list_admin();
		$rank_list = $bll_admin_info->change_time_formate_list($rank_list);
		$data = [
			'rank_list' => $rank_list,
		];
