...
class Smarty_Internal_Templateparser
{
        ...
        do {
            ...
            if ($yyact >= self::YYNSTATE && $yyact < self::YYNSTATE + self::YYNRULE) {
                ...
                do {
                    ...
                    $nextstate = $this->yy_find_reduce_action($this->yystack[ $this->kkidx ]->stateno,
    ...
    function yy_r1()
    {
        if ($this->yystack[ $this->kkidx + 0 ]->minor != null) {
            $this->current_buffer->append_subtree($this, $this->yystack[ $this->kkidx + 0 ]->minor);
        }
    }
    ...
    function yy_r4()
    {
        if ($this->compiler->has_code) {
            $this->_retvalue = $this->mergePrefixCode($this->yystack[ $this->kkidx + 0 ]->minor);
        } else {
            $this->_retvalue = null;
        }
    ...
    function yy_r5()
    {
        $this->_retvalue = new Smarty_Internal_ParseTree_Text($this->yystack[ $this->kkidx + 0 ]->minor);
    }
    ...
    function yy_r6()
    {
        $code = $this->compiler->compileTag('private_php',
                                            array(array('code' => $this->yystack[ $this->kkidx + 0 ]->minor),
    ...
    function yy_r7()
    {
        ...
        $this->_retvalue = new Smarty_Internal_ParseTree_Tag($this,
                                                             $this->compiler->processNocacheCode("<?php echo '{$this->yystack[$this->kkidx + 0]->minor}';?>\n",
                                                                                                 $this->compiler,
                                                                                                 true));
    ...
    function yy_r8()
    {
        $this->_retvalue = $this->compiler->processText($this->yystack[ $this->kkidx + 0 ]->minor);
    }
    ...
    function yy_r10()
    {
        $this->_retvalue = $this->yystack[ $this->kkidx + - 1 ]->minor . $this->yystack[ $this->kkidx + 0 ]->minor;
    }
    ...
    {
        $var =
            trim(substr($this->yystack[ $this->kkidx + 0 ]->minor, $this->lex->ldel_length, - $this->lex->rdel_length),
                 ' $');
    ...
    {
        $this->_retvalue = $this->compiler->compileTag('private_print_expression', array(),
                                                       array('value' => $this->yystack[ $this->kkidx + 0 ]->minor));
    }
    ...
    {
        $this->_retvalue =
            $this->compiler->compileTag('private_print_expression', $this->yystack[ $this->kkidx + 0 ]->minor,
                                        array('value' => $this->yystack[ $this->kkidx + - 1 ]->minor));
    }

    #line 378 "../smarty/lexer/smarty_internal_templateparser.y"
    function yy_r27()
    {
        $this->_retvalue = $this->compiler->compileTag('assign', array(array('value' => $this->yystack[ $this->kkidx +
        0 ]->minor), array('var' => '\'' . substr($this->yystack[ $this->kkidx + - 2 ]->minor, 1) . '\'')));
    }
    ...
    function yy_r29()
    {
        $this->_retvalue = $this->compiler->compileTag('assign',
                                                       array_merge(array(array('value' => $this->yystack[ $this->kkidx +
                                                       - 1 ]->minor), array('var' => '\'' .
                                                           substr($this->yystack[ $this->kkidx + - 3 ]->minor, 1) .
                                                           '\'')), $this->yystack[ $this->kkidx + 0 ]->minor));
    }
    ...
    function yy_r30()
    {
        $this->_retvalue = $this->compiler->compileTag('assign',
                                                       array_merge(array(array('value' => $this->yystack[ $this->kkidx +
                                                       - 1 ]->minor), array('var' => $this->yystack[ $this->kkidx +
                                                       - 3 ]->minor[ 'var' ])),
                                                                   $this->yystack[ $this->kkidx + 0 ]->minor),
                                                       array('smarty_internal_index' => $this->yystack[ $this->kkidx +
    ...
    function yy_r32()
    {
        if (defined($this->yystack[ $this->kkidx + - 1 ]->minor)) {
            if ($this->security) {
                $this->security->isTrustedConstant($this->yystack[ $this->kkidx + - 1 ]->minor, $this->compiler);
            }
            $this->_retvalue =
                $this->compiler->compileTag('private_print_expression', $this->yystack[ $this->kkidx + 0 ]->minor,
                                            array('value' => $this->yystack[ $this->kkidx + - 1 ]->minor));
        } else {
            $this->_retvalue = $this->compiler->compileTag($this->yystack[ $this->kkidx + - 1 ]->minor,
                                                           $this->yystack[ $this->kkidx + 0 ]->minor);
        }
    }
    ...
    function yy_r33()
    {
        if (defined($this->yystack[ $this->kkidx + 0 ]->minor)) {
            if ($this->security) {
                $this->security->isTrustedConstant($this->yystack[ $this->kkidx + 0 ]->minor, $this->compiler);
            }
            $this->_retvalue = $this->compiler->compileTag('private_print_expression', array(),
                                                           array('value' => $this->yystack[ $this->kkidx + 0 ]->minor));
        } else {
            $this->_retvalue = $this->compiler->compileTag($this->yystack[ $this->kkidx + 0 ]->minor, array());
        }
    }
    ...
    function yy_r34()
    {
        if (defined($this->yystack[ $this->kkidx + - 2 ]->minor)) {
            if ($this->security) {
                $this->security->isTrustedConstant($this->yystack[ $this->kkidx + - 2 ]->minor, $this->compiler);
            }
            $this->_retvalue =
                $this->compiler->compileTag('private_print_expression', $this->yystack[ $this->kkidx + 0 ]->minor,
                                            array('value'        => $this->yystack[ $this->kkidx + - 2 ]->minor,
                                                  'modifierlist' => $this->yystack[ $this->kkidx + - 1 ]->minor));
        } else {
            $this->_retvalue = '<?php ob_start();?>' .
                $this->compiler->compileTag($this->yystack[ $this->kkidx + - 2 ]->minor,
                                            $this->yystack[ $this->kkidx + 0 ]->minor) . '<?php echo ';
            $this->_retvalue .= $this->compiler->compileTag('private_modifier', array(),
                                                            array('modifierlist'  => $this->yystack[ $this->kkidx +
    ...
    function yy_r35()
    {
        $this->_retvalue = $this->compiler->compileTag($this->yystack[ $this->kkidx + - 3 ]->minor,
                                                       $this->yystack[ $this->kkidx + 0 ]->minor,
                                                       array('object_method' => $this->yystack[ $this->kkidx +
                                                       - 1 ]->minor));
    }
    ...
    {
        $this->_retvalue = '<?php ob_start();?>' .
            $this->compiler->compileTag($this->yystack[ $this->kkidx + - 4 ]->minor,
                                        $this->yystack[ $this->kkidx + 0 ]->minor,
                                        array('object_method' => $this->yystack[ $this->kkidx + - 2 ]->minor)) .
            '<?php echo ';
        $this->_retvalue .= $this->compiler->compileTag('private_modifier', array(),
                                                        array('modifierlist'  => $this->yystack[ $this->kkidx +
                                                        - 1 ]->minor, 'value' => 'ob_get_clean()')) . ';?>';
    ...
    function yy_r37()
    {
        $tag = trim(substr($this->yystack[ $this->kkidx + - 1 ]->minor, $this->lex->ldel_length));
        $this->_retvalue = $this->compiler->compileTag(($tag == 'else if') ? 'elseif' : $tag, array(),
                                                       array('if condition' => $this->yystack[ $this->kkidx +
                                                       0 ]->minor));
    }
    ...
    function yy_r38()
    {
        $tag = trim(substr($this->yystack[ $this->kkidx + - 2 ]->minor, $this->lex->ldel_length));
    ...
    function yy_r41()
    {
        $this->_retvalue = $this->compiler->compileTag('for', array_merge($this->yystack[ $this->kkidx + 0 ]->minor,
                                                                          array(array('start' => $this->yystack[ $this->kkidx +
                                                                          - 6 ]->minor),
                                                                                array('ifexp' => $this->yystack[ $this->kkidx +
                                                                                - 4 ]->minor),
                                                                                array('var' => $this->yystack[ $this->kkidx +
                                                                                - 2 ]->minor),
                                                                                array('step' => $this->yystack[ $this->kkidx +
                                                                                - 1 ]->minor))), 1);
    }
    ...
    function yy_r44()
    {
        $this->_retvalue = $this->compiler->compileTag('for', array_merge($this->yystack[ $this->kkidx + 0 ]->minor,
                                                                          array(array('start' => $this->yystack[ $this->kkidx +
                                                                          - 3 ]->minor),
                                                                                array('to' => $this->yystack[ $this->kkidx +
                                                                                - 1 ]->minor))), 0);
    }
    ...
    function yy_r46()
    {
        $this->_retvalue = $this->compiler->compileTag('foreach', $this->yystack[ $this->kkidx + 0 ]->minor);
    }

    #line 511 "../smarty/lexer/smarty_internal_templateparser.y"
    function yy_r47()
    {
        $this->_retvalue = $this->compiler->compileTag('foreach', array_merge($this->yystack[ $this->kkidx + 0 ]->minor,
                                                                              array(array('from' => $this->yystack[ $this->kkidx +
                                                                              - 3 ]->minor),
                                                                                    array('item' => $this->yystack[ $this->kkidx +
                                                                                    - 1 ]->minor))));
    }
    ...
    function yy_r48()
    {
        $this->_retvalue = $this->compiler->compileTag('foreach', array_merge($this->yystack[ $this->kkidx + 0 ]->minor,
                                                                              ...
                                                                              - 5 ]->minor),
                                                                                    array('item' => $this->yystack[ $this->kkidx +
                                                                                    - 1 ]->minor),
                                                                                    array('key' => $this->yystack[ $this->kkidx +
                                                                                    - 3 ]->minor))));
    }
    ...
    function yy_r51()
    {
        $this->_retvalue = $this->compiler->compileTag('setfilter', array(),
                                                       array('modifier_list' => array(array_merge(array($this->yystack[ $this->kkidx +
                                                       - 1 ]->minor), $this->yystack[ $this->kkidx + 0 ]->minor))));
    }
    ...
    {
        $this->_retvalue = $this->compiler->compileTag('setfilter', array(),
                                                       array('modifier_list' => array_merge(array(array_merge(array($this->yystack[ $this->kkidx +
                                                       - 2 ]->minor), $this->yystack[ $this->kkidx + - 1 ]->minor)),
                                                                                            $this->yystack[ $this->kkidx +
                                                                                            0 ]->minor)));
    }
    ...
    function yy_r53()
    {
        $j = strrpos($this->yystack[ $this->kkidx + 0 ]->minor, '.');
        if ($this->yystack[ $this->kkidx + 0 ]->minor[ $j + 1 ] == 'c') {
            // {$smarty.block.child}
    ...
    function yy_r55()
    {
        $this->_retvalue = $this->compiler->compileTag($this->yystack[ $this->kkidx + 0 ]->minor . 'close', array());
    }

    #line 563 "../smarty/lexer/smarty_internal_templateparser.y"
    function yy_r56()
    {
        $this->_retvalue = $this->compiler->compileTag($this->yystack[ $this->kkidx + - 1 ]->minor . 'close', array(),
                                                       array('modifier_list' => $this->yystack[ $this->kkidx +
                                                       0 ]->minor));
    }
    ...
    function yy_r57()
    {
        $this->_retvalue = $this->compiler->compileTag($this->yystack[ $this->kkidx + - 2 ]->minor . 'close', array(),
                                                       array('object_method' => $this->yystack[ $this->kkidx +
                                                       0 ]->minor));
    }
    ...
    function yy_r58()
    {
        $this->_retvalue = $this->compiler->compileTag($this->yystack[ $this->kkidx + - 3 ]->minor . 'close', array(),
                                                       array('object_method'         => $this->yystack[ $this->kkidx +
                                                       - 1 ]->minor, 'modifier_list' => $this->yystack[ $this->kkidx +
                                                       0 ]->minor));
    }
    ...
    function yy_r60()
    {
        $this->_retvalue = array($this->yystack[ $this->kkidx + 0 ]->minor);
    }
    ...
    function yy_r62()
    {
        if (defined($this->yystack[ $this->kkidx + 0 ]->minor)) {
            ...
            $this->_retvalue =
                array($this->yystack[ $this->kkidx + - 2 ]->minor => $this->yystack[ $this->kkidx + 0 ]->minor);
        } else {
            $this->_retvalue =
                array($this->yystack[ $this->kkidx + - 2 ]->minor => '\'' . $this->yystack[ $this->kkidx + 0 ]->minor .
                    '\'');
    ...
    {
        $this->_retvalue =
            array(trim($this->yystack[ $this->kkidx + - 1 ]->minor, " =\n\r\t") => $this->yystack[ $this->kkidx +
            0 ]->minor);
    }
    ...
    function yy_r70()
    {
        $this->yystack[ $this->kkidx + - 2 ]->minor[] = $this->yystack[ $this->kkidx + 0 ]->minor;
        $this->_retvalue = $this->yystack[ $this->kkidx + - 2 ]->minor;
    }

    #line 645 "../smarty/lexer/smarty_internal_templateparser.y"
    function yy_r71()
    {
        $this->_retvalue = array('var'   => '\'' . substr($this->yystack[ $this->kkidx + - 2 ]->minor, 1) . '\'',
    ...
    function yy_r73()
    {
        $this->_retvalue = array('var'   => $this->yystack[ $this->kkidx + - 2 ]->minor,
                                 'value' => $this->yystack[ $this->kkidx + 0 ]->minor);
    }
    ...
    {
        $this->_retvalue =
            '$_smarty_tpl->getStreamVariable(\'' . substr($this->yystack[ $this->kkidx + - 2 ]->minor, 1) . '://' .
            $this->yystack[ $this->kkidx + 0 ]->minor . '\')';
    }
    ...
    {
        $this->_retvalue =
            $this->yystack[ $this->kkidx + - 2 ]->minor . trim($this->yystack[ $this->kkidx + - 1 ]->minor) .
            $this->yystack[ $this->kkidx + 0 ]->minor;
    }
    ...
    function yy_r81()
    {
        $this->_retvalue = $this->compiler->compileTag('private_modifier', array(),
                                                       array('value' => $this->yystack[ $this->kkidx + - 1 ]->minor,
                                                             'modifierlist' => $this->yystack[ $this->kkidx +
                                                             0 ]->minor));
    }
    ...
    function yy_r82()
    {
        $this->_retvalue = (isset($this->yystack[ $this->kkidx + - 1 ]->minor[ 'pre' ]) ?
                $this->yystack[ $this->kkidx + - 1 ]->minor[ 'pre' ] : '') .
            $this->yystack[ $this->kkidx + - 2 ]->minor . $this->yystack[ $this->kkidx + - 1 ]->minor[ 'op' ] .
            $this->yystack[ $this->kkidx + 0 ]->minor .
            (isset($this->yystack[ $this->kkidx + - 1 ]->minor[ 'pre' ]) ? ')' : '');
    }
    ...
    {
        $this->_retvalue =
            $this->yystack[ $this->kkidx + 0 ]->minor . $this->yystack[ $this->kkidx + - 1 ]->minor . ')';
    }

    #line 708 "../smarty/lexer/smarty_internal_templateparser.y"
    function yy_r84()
    {
        $this->_retvalue = 'in_array(' . $this->yystack[ $this->kkidx + - 2 ]->minor . ',' .
            $this->yystack[ $this->kkidx + 0 ]->minor . ')';
    }
    ...
    function yy_r85()
    {
        $this->_retvalue = 'in_array(' . $this->yystack[ $this->kkidx + - 2 ]->minor . ',(array)' .
            $this->yystack[ $this->kkidx + 0 ]->minor . ')';
    }
    ...
    function yy_r86()
    {
        $this->_retvalue = $this->yystack[ $this->kkidx + - 2 ]->minor . $this->yystack[ $this->kkidx + - 1 ]->minor .
            $this->yystack[ $this->kkidx + 0 ]->minor;
    }
    ...
    function yy_r88()
    {
        $this->_retvalue = $this->yystack[ $this->kkidx + - 5 ]->minor . ' ? ' .
            $this->compiler->compileVariable('\'' . substr($this->yystack[ $this->kkidx + - 2 ]->minor, 1) . '\'') .
            ' : ' . $this->yystack[ $this->kkidx + 0 ]->minor;
    }
    ...
    {
        $this->_retvalue =
            $this->yystack[ $this->kkidx + - 5 ]->minor . ' ? ' . $this->yystack[ $this->kkidx + - 2 ]->minor . ' : ' .
            $this->yystack[ $this->kkidx + 0 ]->minor;
    }
    ...
    {
        self::$prefix_number ++;
        if ($this->yystack[ $this->kkidx + - 2 ]->minor[ 'var' ] == '\'smarty\'') {
            $this->compiler->prefix_code[] = '<?php $_tmp' . self::$prefix_number . ' = ' .
                $this->compiler->compileTag('private_special_variable', array(),
                                            $this->yystack[ $this->kkidx + - 2 ]->minor[ 'smarty_internal_index' ]) .
                ';?>';
        } else {
            $this->compiler->prefix_code[] = '<?php $_tmp' . self::$prefix_number . ' = ' .
                $this->compiler->compileVariable($this->yystack[ $this->kkidx + - 2 ]->minor[ 'var' ]) .
                $this->yystack[ $this->kkidx + - 2 ]->minor[ 'smarty_internal_index' ] . ';?>';
        }
        $this->_retvalue = '$_tmp' . self::$prefix_number . '::' . $this->yystack[ $this->kkidx + 0 ]->minor[ 0 ] .
            $this->yystack[ $this->kkidx + 0 ]->minor[ 1 ];
    }
    ...
    {
        self::$prefix_number ++;
        $tmp = $this->compiler->appendCode('<?php ob_start();?>', $this->yystack[ $this->kkidx + 0 ]->minor);
    ...
    function yy_r109()
    {
        if (!in_array(strtolower($this->yystack[ $this->kkidx + - 2 ]->minor), array('self', 'parent')) &&
            (!$this->security ||
                $this->security->isTrustedStaticClassAccess($this->yystack[ $this->kkidx + - 2 ]->minor,
                                                            $this->yystack[ $this->kkidx + 0 ]->minor, $this->compiler))
        ) {
            if (isset($this->smarty->registered_classes[ $this->yystack[ $this->kkidx + - 2 ]->minor ])) {
                $this->_retvalue =
                    $this->smarty->registered_classes[ $this->yystack[ $this->kkidx + - 2 ]->minor ] . '::' .
                    $this->yystack[ $this->kkidx + 0 ]->minor[ 0 ] . $this->yystack[ $this->kkidx + 0 ]->minor[ 1 ];
            } else {
                $this->_retvalue = $this->yystack[ $this->kkidx + - 2 ]->minor . '::' .
                    $this->yystack[ $this->kkidx + 0 ]->minor[ 0 ] . $this->yystack[ $this->kkidx + 0 ]->minor[ 1 ];
            }
        } else {
            $this->compiler->trigger_template_error("static class '" . $this->yystack[ $this->kkidx + - 2 ]->minor .
    ...
    {
        $this->_retvalue =
            $this->compiler->compileVariable('\'' . substr($this->yystack[ $this->kkidx + 0 ]->minor, 1) . '\'');
    }

    #line 874 "../smarty/lexer/smarty_internal_templateparser.y"
    function yy_r113()
    {
        if ($this->yystack[ $this->kkidx + 0 ]->minor[ 'var' ] == '\'smarty\'') {
            ...
            $this->last_variable = $this->yystack[ $this->kkidx + 0 ]->minor[ 'var' ];
            $this->last_index = $this->yystack[ $this->kkidx + 0 ]->minor[ 'smarty_internal_index' ];
            $this->_retvalue = $this->compiler->compileVariable($this->yystack[ $this->kkidx + 0 ]->minor[ 'var' ]) .
                $this->yystack[ $this->kkidx + 0 ]->minor[ 'smarty_internal_index' ];
        }
    }
    ...
    function yy_r114()
    {
        $this->_retvalue = '$_smarty_tpl->tpl_vars[' . $this->yystack[ $this->kkidx + - 2 ]->minor . ']->' .
            $this->yystack[ $this->kkidx + 0 ]->minor;
    }
    ...
    {
        $this->_retvalue =
            $this->compiler->compileConfigVariable("'" . $this->yystack[ $this->kkidx + - 1 ]->minor . "'");
    }
    ...
    function yy_r117()
    {
        $this->_retvalue = '(is_array($tmp = ' .
            $this->compiler->compileConfigVariable("'" . $this->yystack[ $this->kkidx + - 2 ]->minor . "'") .
            ') ? $tmp' . $this->yystack[ $this->kkidx + 0 ]->minor . ' :null)';
    }

    #line 905 "../smarty/lexer/smarty_internal_templateparser.y"
    function yy_r118()
    {
        $this->_retvalue = $this->compiler->compileConfigVariable($this->yystack[ $this->kkidx + - 1 ]->minor);
    }
    ...
    {
        $this->_retvalue =
            '(is_array($tmp = ' . $this->compiler->compileConfigVariable($this->yystack[ $this->kkidx + - 2 ]->minor) .
            ') ? $tmp' . $this->yystack[ $this->kkidx + 0 ]->minor . ' : null)';
    }
    ...
    function yy_r120()
    {
        $this->_retvalue = array('var' => '\'' . substr($this->yystack[ $this->kkidx + - 1 ]->minor, 1) . '\'',
                                 'smarty_internal_index' => $this->yystack[ $this->kkidx + 0 ]->minor);
    }

    #line 916 "../smarty/lexer/smarty_internal_templateparser.y"
    function yy_r121()
    {
        $this->_retvalue = array('var'                   => $this->yystack[ $this->kkidx + - 1 ]->minor,
                                 'smarty_internal_index' => $this->yystack[ $this->kkidx + 0 ]->minor);
    }
    ...
    function yy_r125()
    {
        $this->_retvalue = '[' . $this->compiler->compileVariable($this->yystack[ $this->kkidx + 0 ]->minor) . ']';
    }

    #line 942 "../smarty/lexer/smarty_internal_templateparser.y"
    function yy_r126()
    {
        $this->_retvalue = '[' . $this->compiler->compileVariable($this->yystack[ $this->kkidx + - 2 ]->minor) . '->' .
            $this->yystack[ $this->kkidx + 0 ]->minor . ']';
    }
    ...
    {
        $this->_retvalue = '[' .
            $this->compiler->compileVariable('\'' . substr($this->yystack[ $this->kkidx + - 1 ]->minor, 1) . '\'') .
            ']';;
    }
    ...
    function yy_r139()
    {
        $this->_retvalue = '\'' . substr($this->yystack[ $this->kkidx + 0 ]->minor, 1) . '\'';
    }
    ...
    {
        $this->_retvalue =
            $this->yystack[ $this->kkidx + - 1 ]->minor . '.' . $this->yystack[ $this->kkidx + 0 ]->minor;
    }
    ...
    function yy_r145()
    {
        if ($this->yystack[ $this->kkidx + - 1 ]->minor[ 'var' ] == '\'smarty\'') {
            $this->_retvalue = $this->compiler->compileTag('private_special_variable', array(),
                                                           $this->yystack[ $this->kkidx +
                                                           - 1 ]->minor[ 'smarty_internal_index' ]) .
                $this->yystack[ $this->kkidx + 0 ]->minor;
        } else {
            $this->_retvalue = $this->compiler->compileVariable($this->yystack[ $this->kkidx + - 1 ]->minor[ 'var' ]) .
                $this->yystack[ $this->kkidx + - 1 ]->minor[ 'smarty_internal_index' ] .
                $this->yystack[ $this->kkidx + 0 ]->minor;
        }
    }
    ...
    function yy_r148()
    {
        if ($this->security && substr($this->yystack[ $this->kkidx + - 1 ]->minor, 0, 1) == '_') {
    ...
    function yy_r149()
    {
        ...
        $this->_retvalue = '->{' . $this->compiler->compileVariable($this->yystack[ $this->kkidx + - 1 ]->minor) .
            $this->yystack[ $this->kkidx + 0 ]->minor . '}';
    }
    ...
    function yy_r151()
    {
        ...
        $this->_retvalue = '->{\'' . $this->yystack[ $this->kkidx + - 4 ]->minor . '\'.' .
            $this->yystack[ $this->kkidx + - 2 ]->minor . $this->yystack[ $this->kkidx + 0 ]->minor . '}';
    }
    ...
    {
        if (!$this->security ||
            $this->security->isTrustedPhpFunction($this->yystack[ $this->kkidx + - 3 ]->minor, $this->compiler)
        ) {
            if (strcasecmp($this->yystack[ $this->kkidx + - 3 ]->minor, 'isset') === 0 ||
                strcasecmp($this->yystack[ $this->kkidx + - 3 ]->minor, 'empty') === 0 ||
                strcasecmp($this->yystack[ $this->kkidx + - 3 ]->minor, 'array') === 0 ||
                is_callable($this->yystack[ $this->kkidx + - 3 ]->minor)
            ) {
                $func_name = strtolower($this->yystack[ $this->kkidx + - 3 ]->minor);
                if ($func_name == 'isset') {
                    if (count($this->yystack[ $this->kkidx + - 1 ]->minor) == 0) {
                        $this->compiler->trigger_template_error('Illegal number of paramer in "isset()"');
                    }
                    $par = implode(',', $this->yystack[ $this->kkidx + - 1 ]->minor);
                    ...
                    $this->_retvalue = $this->yystack[ $this->kkidx + - 3 ]->minor . "(" . $isset_par . ")";
                } elseif (in_array($func_name, array('empty', 'reset', 'current', 'end', 'prev', 'next'))) {
                    if (count($this->yystack[ $this->kkidx + - 1 ]->minor) != 1) {
                    ...
                    if ($func_name == 'empty') {
                        ...
                        $this->_retvalue = $func_name . '(' . $this->yystack[ $this->kkidx + - 1 ]->minor[ 0 ] . ')';
                    }
                } else {
                    $this->_retvalue = $this->yystack[ $this->kkidx + - 3 ]->minor . "(" .
                        implode(',', $this->yystack[ $this->kkidx + - 1 ]->minor) . ")";
                }
            } else {
                $this->compiler->trigger_template_error("unknown function \"" .
                                                        $this->yystack[ $this->kkidx + - 3 ]->minor . "\"");
            }
        }
    }
    ...
    function yy_r154()
    {
        if ($this->security && substr($this->yystack[ $this->kkidx + - 3 ]->minor, 0, 1) == '_') {
            $this->compiler->trigger_template_error(self::Err1);
        }
        $this->_retvalue = $this->yystack[ $this->kkidx + - 3 ]->minor . "(" .
            implode(',', $this->yystack[ $this->kkidx + - 1 ]->minor) . ")";
    ...
    function yy_r155()
    {
        ...
        self::$prefix_number ++;
        $this->compiler->prefix_code[] = '<?php $_tmp' . self::$prefix_number . '=' .
            $this->compiler->compileVariable('\'' . substr($this->yystack[ $this->kkidx + - 3 ]->minor, 1) . '\'') .
            ';?>';
        $this->_retvalue =
            '$_tmp' . self::$prefix_number . '(' . implode(',', $this->yystack[ $this->kkidx + - 1 ]->minor) . ')';
    }
    ...
    {
        $this->_retvalue =
            array_merge($this->yystack[ $this->kkidx + - 2 ]->minor, array($this->yystack[ $this->kkidx + 0 ]->minor));
    }

    #line 1166 "../smarty/lexer/smarty_internal_templateparser.y"
    function yy_r159()
    {
        $this->_retvalue = array_merge($this->yystack[ $this->kkidx + - 2 ]->minor,
                                       array(array_merge($this->yystack[ $this->kkidx + - 1 ]->minor,
                                                         $this->yystack[ $this->kkidx + 0 ]->minor)));
    }
    ...
    {
        $this->_retvalue =
            array(array_merge($this->yystack[ $this->kkidx + - 1 ]->minor, $this->yystack[ $this->kkidx + 0 ]->minor));
    }
    ...
    {
        $this->_retvalue =
            array_merge($this->yystack[ $this->kkidx + - 1 ]->minor, $this->yystack[ $this->kkidx + 0 ]->minor);
    }

    #line 1205 "../smarty/lexer/smarty_internal_templateparser.y"
    function yy_r167()
    {
        $this->_retvalue = array($this->yystack[ $this->kkidx + 0 ]->minor, '', 'method');
    }
    ...
    {
        $this->_retvalue =
            array($this->yystack[ $this->kkidx + - 1 ]->minor, $this->yystack[ $this->kkidx + 0 ]->minor, 'method');
    }
    ...
    {
        $this->_retvalue =
            array($this->yystack[ $this->kkidx + - 1 ]->minor, $this->yystack[ $this->kkidx + 0 ]->minor, 'property');
    }

    #line 1225 "../smarty/lexer/smarty_internal_templateparser.y"
    function yy_r171()
    {
        $this->_retvalue = array($this->yystack[ $this->kkidx + - 2 ]->minor,
                                 $this->yystack[ $this->kkidx + - 1 ]->minor .
                                 $this->yystack[ $this->kkidx + 0 ]->minor, 'property');
    }

    #line 1231 "../smarty/lexer/smarty_internal_templateparser.y"
    function yy_r172()
    {
        $this->_retvalue[ 'op' ] = ' ' . trim($this->yystack[ $this->kkidx + 0 ]->minor) . ' ';
    }
    ...
    function yy_r173()
    {
        ...
        $op = strtolower(preg_replace('/\s*/', '', $this->yystack[ $this->kkidx + 0 ]->minor));
    ...
    function yy_r174()
    {
        ...
        $op = strtolower(str_replace(' ', '', $this->yystack[ $this->kkidx + 0 ]->minor));
    ...
    function yy_r175()
    {
        $this->_retvalue = 'array(' . $this->yystack[ $this->kkidx + - 1 ]->minor . ')';
    }
    ...
    function yy_r183()
    {
        $this->_retvalue = $this->yystack[ $this->kkidx + - 1 ]->minor->to_smarty_php($this);
    }

    #line 1316 "../smarty/lexer/smarty_internal_templateparser.y"
    function yy_r184()
    {
        $this->yystack[ $this->kkidx + - 1 ]->minor->append_subtree($this, $this->yystack[ $this->kkidx + 0 ]->minor);
        $this->_retvalue = $this->yystack[ $this->kkidx + - 1 ]->minor;
    }
    ...
    function yy_r185()
    {
        $this->_retvalue = new Smarty_Internal_ParseTree_Dq($this, $this->yystack[ $this->kkidx + 0 ]->minor);
    }

    #line 1325 "../smarty/lexer/smarty_internal_templateparser.y"
    function yy_r186()
    {
        $this->_retvalue = new Smarty_Internal_ParseTree_Code('(string)' . $this->yystack[ $this->kkidx + - 1 ]->minor);
    }
    ...
    function yy_r188()
    {
        $this->_retvalue = new Smarty_Internal_ParseTree_Code('(string)$_smarty_tpl->tpl_vars[\'' .
                                                              substr($this->yystack[ $this->kkidx + 0 ]->minor, 1) .
                                                              '\']->value');
    }
    ...
    {
        $this->_retvalue =
            new Smarty_Internal_ParseTree_Code('(string)(' . $this->yystack[ $this->kkidx + - 1 ]->minor . ')');
    }

    #line 1345 "../smarty/lexer/smarty_internal_templateparser.y"
    function yy_r191()
    {
        $this->_retvalue = new Smarty_Internal_ParseTree_Tag($this, $this->yystack[ $this->kkidx + 0 ]->minor);
    }

    #line 1349 "../smarty/lexer/smarty_internal_templateparser.y"
    function yy_r192()
    {
        $this->_retvalue = new Smarty_Internal_ParseTree_DqContent($this->yystack[ $this->kkidx + 0 ]->minor);
    }
            ...
            if ($yyact < self::YYNSTATE) {
                ...
                if (self::YYERRORSYMBOL) {
                    ...
                    if ($yymx == self::YYERRORSYMBOL || $yyerrorhit) {
                        ...
                        while ($this->kkidx >= 0 && $yymx != self::YYERRORSYMBOL &&
