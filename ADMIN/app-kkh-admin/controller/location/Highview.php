...
class Location_HighviewController extends APF_Controller
{
    private $pdo;
    ...
    private function get_location_list($kkid, $limit, $offset)
    {
        ...
        $sql = "select kkid, name, type_code, type_desc, rank, name_code, map_x, map_y, map_zoom, area_level from t_location where status = 1 and area_level = 2  order by rank asc, type_code asc LIMIT :limit OFFSET :offset ;";
    ...
    private function get_location_count($kkid='')
    {
        ...
        $c = 0;
        $get_count_sql = "select count(*) c from t_location where status=1 and area_level=2;";
