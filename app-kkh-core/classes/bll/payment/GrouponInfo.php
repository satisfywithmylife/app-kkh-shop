...
class  Bll_Payment_GrouponInfo {
	    private $paymentGrouponInfoDao;

	    public function __construct() {
		        $this->paymentGrouponInfoDao = new Dao_Payment_GrouponInfo();
	    }
        ...
        public function create_payment_charge($data) {
                return $this->paymentGrouponInfoDao->create_payment_charge($data);
        }
        ...
        public function get_payment_charge_list($r_kkid, $limit, $offset)
        {
                ...
                return $this->paymentGrouponInfoDao->get_payment_charge_list($r_kkid, $limit, $offset);
        }
