...
class Order_ModifyOrderStatus extends APF_Controller {
    ...
    public function handle_request() {
        ...
        if($id_order <= 0 || !in_array($order_status, array(-1, 1, 2, 4, 6, 7, 13))) {
            self::$error_ret['msg'] = 'invalid param';
            echo json_encode(self::$error_ret);
            return false;
        }
        ...
        $ret = $bll_order->modify_order_status($id_order, $operator, $order_status);
