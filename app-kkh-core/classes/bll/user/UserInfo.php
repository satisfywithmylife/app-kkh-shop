...
class  Bll_User_UserInfo {
	private $userInfoDao;
	private $customerInfoDao;

	public function __construct() {
		$this->userInfoDao = new Dao_User_UserInfoMemcache();
    ...
    public function get_user_info_by_wx_info($wx_openid, $wx_unionid) {
        ...
        return $this->userInfoDao->get_user_info_by_wx_info($wx_openid, $wx_unionid);
    }
	...
	public function get_user_by_kkid($kkid) {
		...
		$userinfo = new Dao_User_UserInfo();
                return $userinfo->get_user_by_kkid($kkid);
	}
    ...
    public function wxsignin($wx_openid, $wx_unionid) {
        ...
        $result = $this->userInfoDao->get_user_info_by_wx_info($wx_openid, $wx_unionid);
...
--  [site:name] team";
	...
	**/
	...
	public function get_user_info_by_min_openid($min_openid)
	{
		...
		$info     = $userinfo->get_user_info_by_min_openid($min_openid);
		return $info;
	}
