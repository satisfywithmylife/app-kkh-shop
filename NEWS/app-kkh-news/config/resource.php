...
$config['cdn_host'] = "include.andrew.kangkanghui.com";
$config['cdn_path'] = "/".APP_NAME;
$config['cdn_boundable_host'] = "include.andrew.kangkanghui.com";
$config['cdn_boundable_path'] = "/".APP_NAME;
$config['cdn_pure_static_host'] = "pages.andrew.kangkanghui.com";
$config['cdn_pure_static_path'] = "/a/";
