...
class Cornertags_DelController extends APF_Controller
{
    ...
    {   
		...
		$data['active'] = isset($params['active']) ? $params['active'] : 0;  //1-online,0-offline
		...
		$res = $bll_cornertags_info->del($data);
		if ($res) {
