...
class Cabinet_CounterClearController extends APF_Controller {
...
//        $id_cabinet = intval($param['id_cabinet']);
        ...
        $counter_row = intval($param['row']);
        $counter_column = intval($param['column']);
        ...
        $ret = $bll_cabinet->counter_clear($id_cabinet, $counter_row, $counter_column);
