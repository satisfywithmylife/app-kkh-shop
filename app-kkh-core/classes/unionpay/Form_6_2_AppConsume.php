...
include_once('SDK/SDKConfig.php');
include_once('SDK/secureUtil.php');
include_once('SDK/httpClient.php');
include_once('SDK/log.class.php');
/**
 * 消费交易-控件后台订单推送 
 */
...
$params = array(
		...
		'orderId' => "zzk".$_POST['payment_order_id'],	//商户订单号，8-40位数字字母
		'txnTime' => date('YmdHis'),	//订单发送时间
		'txnAmt' =>  $_POST['payment_order_id'],		//交易金额，单位分
		'currencyCode' => '156',	//交易币种
		'orderDesc' => $_POST['order_info'],  //订单描述，可不上送，上送时控件中会显示该信息
